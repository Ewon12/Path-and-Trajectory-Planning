...
Sphe_Modern.plot(T1_4traj.q,limits =[x1, x2, y1, y2, z1, z2])
Sphe_Modern.plot(T2_4traj.q,limits =[x1, x2, y1, y2, z1, z2])
Sphe_Modern.plot(d3_4traj.q,limits =[x1, x2, y1, y2, z1, z2])
Sphe_Modern.plot(d3_4_returntraj.q,limits =[x1, x2, y1, y2, z1, z2])
Sphe_Modern.plot(T2_4_returntraj .q,limits =[x1, x2, y1, y2, z1, z2])
